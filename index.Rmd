...
output:
  ...
  vitae::moderncv:
      ...
      keep_tex: true
      extra_dependencies: ["pgf"]
      theme: "classic"
      pandoc_args: ["--lua-filter=promote-headings.lua"]
      includes:
...
<!-- | **Science and Technology Studies** |   | science for policy, environmental policy                       | -->
<!-- | **Data Science**                   |   | text mining, bibliometrics, philosophy of statistical practice | -->
...
National Robotics Initiative', 'American Assocation for the Advancement of Science',
    ...
    'Postdoctoral Fellow', '2012-2013', 'College of Arts and Letters and Department of Philosophy', 'University of Notre Dame'
      ...
      detailed_entries(title, year, department, institution)
```
...
```{r}
read_sheet(
      'https://docs.google.com/spreadsheets/d/1nKDb1e4rmZBlp_KfDAJkQKRij4btkDewAH-hB6MnxT0/edit#gid=0',
      col_types = 'cDccc'
) |>
      detailed_entries(
            what = what,
...
```{r}
read_sheet(
      'https://docs.google.com/spreadsheets/d/1Ply5ydXH25Vve1U9TZ_VZLsYL2f6dJIlv2L1Uaiw4Ew/edit#gid=0',
      col_types = 'cDccc'
) |>
      detailed_entries(
            what = what,
...
\begin{cvbullets}
```
- Daisy Underhill (UC Davis, Ph.D., committee member)
- Aaron Chavez (UC Davis, Ph.D., committee member; graduated 2026)
- Rebecca Korf (UC Irvine, Ph.D., committee member; graduated 2025)
- Emilio Lobato (UC Merced, Ph.D., co-advisor; graduated 2024)
- Dennis Perez (UC Merced, M.A., committee member; graduated 2022)
```{=latex}
\end{cvbullets}
```
...
\begin{cvbullets}
```
- Kino Zhao (UC Irvine, Ph.D. 2021)
- Michelle Pham (Univ. of Washington, Ph.D. 2020)
```{=latex}
\end{cvbullets}
```
...
\begin{cvbullets}
```
- Danna Valenzuela (UC Merced, undergraduate, research supervisor)
...
```{r, include=FALSE}
# read_sheet(
#       'https://docs.google.com/spreadsheets/d/1nKDb1e4rmZBlp_KfDAJkQKRij4btkDewAH-hB6MnxT0/edit?gid=670362183#gid=670362183',
#       sheet = 'peer review'
# ) |>
