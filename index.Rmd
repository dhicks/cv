...
tribble(
    ...
    'Department Chair', '2023-', 'Department of Philosophy', 'University of California, Merced',
...
read_sheet('https://docs.google.com/spreadsheets/d/1nKDb1e4rmZBlp_KfDAJkQKRij4btkDewAH-hB6MnxT0/edit#gid=0', 
                 col_types = 'cDccc') |> 
    detailed_entries(what = what, when = when, with = where, where = with, why = why, .protect = FALSE) |> 
    format_dates()
```
